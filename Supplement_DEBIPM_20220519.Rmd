...
We adjust the parameter values of mass dependent consumption and allocation in the DEB model to fit data on the observed growth and fecundity of Windermere pike (see main text for details). The growth data on Windermere pike is based on back-calculated length (Winfield et al. 2013b).  The data on fecundity and growth represents individuals caught between 1944-2003 and therefore encompass a wide temperature range (Winfield et al. 2013, 2013a, 2013b). We convert length to weight based on our estimated length to weight relationship (eq. 11, main text). Figure S2 shows how our estimates compare with data for mean growth (growth trajectories, Fig. S2A) and variance (Fig. S2C) and reproduction (S2B, fecundity in October-December).
