...
ranT <- 
 ggplot() +
  geom_line(data=optim.data$growthTemp, aes(Age, ltow(Length), group = as.factor(Ind), color = "WData")) +
...
ggplot() +
  ...
  geom_point(data = optim.data$growthTemp, aes(Age, mass), alpha=0.2, shape=4) +
  geom_line(data = optim.data$out.optim$g, aes(Age, Mass, color = "#91bfdb"), size=0.85) +
...
ggplot() +
  ...
  geom_point(data=optim.data$fecTemp, aes(ltow(Length), Egg_number*Egg_weight/e_m), alpha=0.2, shape=4) +
...
groT_const <- ggplot(trajG_mi) +
  geom_point(data=optim.data$growthTemp, aes(Age, mass), alpha=0.1) +
...
repT_const <-
  ggplot() +
  geom_point(data=optim.data$fecTemp, aes(mass, Egg_number*Egg_weight/e_m), alpha=0.1) +
